...
def build_proclamation():
    with gr.Column():
        gr.Markdown(
            ...
            ### 🫁 Start Training
            **Practice the breathing maneuver** as many times as you **want**.
            The AI will provide coaching and feedback after every attempt.
            
            ### 🎯 Skip to Real Test
            **Proceed directly to the live test.**  
            The **respiratory therapist** or AI Companion will guide you through the same steps, but the results will be saved as your official test attempt.
            """
        )
        ...
        gr.Markdown(
            """
            ⚠️ **Disclaimer:** Educational purposes only. Not a substitute for professional clinical judgment or diagnosis.
            """
        )
