"""
=========================================================
Spirometry V41 – Fixed Audio Repeats & Mode Switching
...
def run_coaching(mode):
    ...
    if COACHING_IN_PROGRESS:
        # Return a friendly message without speaking
        return mode, "🔴 Coaching already in progress...", get_coaching_html("Please wait for the current coaching to finish.")
...
def build_spirometry():
    ...
    with gr.Column():
        gr.Markdown("""
        <div class="main-title">AI Spirometry Companion (V41 🫁)</div>
...
if __name__ == "__main__":
    ...
    with gr.Blocks(title="PFT AI Companion V41") as demo:
        print("🟢 9. Building UI...")
        build_spirometry()
